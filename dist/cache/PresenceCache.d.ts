...
declare class PresenceCache extends BaseCache<import("@amanda/discordtypings").PresenceData> {
    ...
    constructor(storageEngine: BaseStorageEngine<import("@amanda/discordtypings").PresenceData>, userCache: import("./UserCache"), boundObject?: import("@amanda/discordtypings").PresenceData);
