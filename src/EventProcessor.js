...
class EventProcessor extends EventEmitter {
	 ...
	 * @param {Object.<string, boolean>} [options.disabledEvents]
	 * @param {number} [options.presenceInterval]
	 * @param {Object} [options.cache]
	 * @param {import("./cache/GuildCache")} options.cache.guild
	 * @param {import("./cache/ChannelCache")} options.cache.channel
	 * @param {import("./cache/MemberCache")} options.cache.member
	 * @param {import("./cache/RoleCache")} options.cache.role
	 * @param {import("./cache/UserCache")} options.cache.user
